...
patch_conf() {
  ...
  # cd $JUPITER_DIR && wget http://archive.ubuntu.com/ubuntu/pool/main/o/openssl/openssl_1.0.2g.orig.tar.gz;
  # tar -xf openssl_1.0.2g.orig.tar.gz;
  # cd openssl-1.0.2g/ && CC=armv7-mx5-linux-gnueabi-gcc ./Configure linux-armv4

  # export PKG_CONFIG_PATH=/root/x-tools/armv7-mx5-linux-gnueabi/armv7-mx5-linux-gnueabi/sysroot/usr/lib/pkgconfig/
  # apt install -y rename locales libc6-i386 lib32stdc++6 subversion git cmake astyle libglib2.0-0:i386 gettext python3 libdbus-1-dev
